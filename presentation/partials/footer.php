...
<script>window.jQuery || document.write('<script src="/docs/4.3/assets/js/vendor/jquery-slim.min.js"><\/script>')</script><script src="<?php echo $GLOBALS['URL']; ?>includes/js/bootstrap.bundle.min.js"></script>
